...
enum msg_hash_enums
{
   ...
   MENU_LABEL(PROFILES_LIST),
   MENU_LABEL(PROFILE_CREATE),
   MENU_LABEL(PROFILE_SELECT),
   MENU_LABEL(PROFILE_ICON_SELECT),
   MENU_LABEL(PROFILE_SAVE_CURRENT),
   MENU_LABEL(PROFILE_SAVE_NEW),
   MENU_LABEL(PROFILE_DELETE),
